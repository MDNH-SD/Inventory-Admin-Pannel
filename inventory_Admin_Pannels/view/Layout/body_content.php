    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form class="shadow p-4">                  
                <div class="mb-3">
                    <label for="cat_name">Category Name</label><span style='color:red';> * </span><?php if(!empty($errmsg1 )){echo $errmsg1 ;}?>
                ...
                <div class="mb-3">
                    <label for="cat_details">Category code</label><span style='color:red';> * </span>  <?php if(!empty($errmsg2 )){echo $errmsg2 ;}?>
                    <input  type="text" value="<?php if(!empty($cat_code )){echo $cat_code;}?>" class="form-control" name="cat_code" id="cat_code" placeholder="Category Code">
